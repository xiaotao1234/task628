...
public class System_Param_Fragment extends BasePreferenceFragment {
    @SuppressLint("RestrictedApi")
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.activity_system_param);

        PreferenceManager mPreferenceManager = getPreferenceManager();

        PreferenceScreen prfs = mPreferenceManager.getPreferenceScreen();

        bindPreferenceSummaryToValue(Objects.requireNonNull(prfs.findPreference("ServerIP")));
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        String ip = sp.getString("ServerIP", "192.168.0.11");
